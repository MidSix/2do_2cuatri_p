...
if __name__ == "__main__":#Voy a usar argparse porque me es bastante cómodo -> okay, a mi tambien me parece guay.
    # Es curioso que el parser en si sea un automata.
    parser = argparse.ArgumentParser(description="siw.py - State Indexing Weights")
    parser.add_argument('input_bin', help="Pasa el path del fichero con la versión compilada de un autómata finito acíclico.")
    parser.add_argument('output_bin', help="Pasa el path del fichero de salida en el que se guardará la nueva versión con los pesos.")
